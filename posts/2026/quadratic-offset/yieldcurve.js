(function () {
  ...
  for (var i = 0; i < N_POINTS; i++) {
    ...
    yNet.push(+(netApr(f) * 100).toFixed(4));
  }
  ...
  var layout = {
    ...
    dragmode: false,
    title: { text: 'CL yield: current gross vs. quadratic-tapered net', font: { size: 14 }, x: 0.5, xanchor: 'center' },
  ...
  var traces = [
    { x: fs, y: yCurrent,
      name: 'Current gross (∝ 1/√f)', type: 'scatter', mode: 'lines',
  ...
  var el = document.getElementById('quadratic-offset-yieldcurve-chart');
