(function () {
  ...
  for (var i = 0; i < N_POINTS; i++) {
    ...
    yNet512.push(+(SCALE_512 * w * base * 100).toFixed(4));
  }
  ...
  var traces = [
    ...
    { x: fs, y: yNet512,
      ...
      hovertemplate: "B'=512: %{y:.3f}%<extra></extra>" },
  ];
  ...
  var el = document.getElementById("quadratic-offset-calibration-chart");
