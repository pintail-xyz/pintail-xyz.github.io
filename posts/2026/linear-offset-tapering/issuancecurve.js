(function () {
  ...
  function annualInflationPctComp(f) {
    return 2 * annualInflationPctNaive(f);
  }
  ...
  var traces = [
    ...
    },
    {
      ...
      hovertemplate: 'Naive taper (B=64): %{y:.3f}%<extra></extra>',
    },
    {
      x: fs, y: yComp,
      ...
      hovertemplate: 'Compensated taper (B=128): %{y:.3f}%<extra></extra>',
    },
  ];
  ...
  var el = document.getElementById('lin4-issuancecurve-chart');
