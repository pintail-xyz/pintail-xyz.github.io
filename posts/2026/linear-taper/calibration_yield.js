(function () {
  ...
  var SCALE_192 = 192 / BASE_REWARD_FACTOR;
  var SCALE_256 = 256 / BASE_REWARD_FACTOR;
  ...
  for (var i = 0; i < N_POINTS; i++) {
    ...
    yNet192.push(+(SCALE_192 * w * apr * 100).toFixed(4));
  ...
  var traces = [
    ...
    { x: fs, y: yNet192,
      ...
      hovertemplate: "B'=192: %{y:.2f}%<extra></extra>" },
    { x: fs, y: yNet256,
  ...
  var el = document.getElementById("linear-taper-calibration-yield-chart");
